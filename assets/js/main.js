...
let svgI = svgW / 460; // 190 = viewBox="..X..X.190..X"
...
function openClose() {
   checkIn.style.color = (currentHour >= 14 && currentHour <= 20) ? "green" : "red";
   checkOut.style.color = (currentHour >= 8 && currentHour <= 10) ? "green" : "red";
}
